...
# Categorizing based on categories 
def categorize_transactions(df):
    ...
    for category, keywords in st.session_state.categories.items():
        ...
        # creating new list of keywords where they are converted to lowercase and stripping them if there are any spaces
        lowered_keywords = [keyword.lower().strip() for keyword in keywords]
        
        # iterates over each row in our dataframe similarly to a list 
            ...
            with tab1:
                ...
                if save_button:
                    for idx, row in edited_df.iterrows():
                        ...
                        # if a change was made to the category, we take the details and update it to modify the state and save it 
                ...
                # takes dataframe and stores it in the state, groups it by category, takes the amount of categories, sums them and resets the index    
